...
- Vite: import.meta.env. VITE_APP_API_BASE_URL (backend), VITE_APP_API_SOCKET_URL
  ...
  VITE_APP_AGENTSAPP_DOMAIN, VITE_APP_ENVIRONMENT,
  VITE_APP_KIRSHNER_WHATSAPP_SOCKET_URL.
...
- Admin: VITE_APP_API_BASE_URL pointing to backend (e.g. http://localhost:5000
  ...
  VITE_APP_STORE_DOMAIN, VITE_APP_LIKUTAPP_DOMAIN, VITE_APP_AGENTSAPP_DOMAIN,
  VITE_APP_KIRSHNER_WHATSAPP_SOCKET_URL.
