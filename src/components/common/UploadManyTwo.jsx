...
const UploadManyTwo = ({
  ...
  return (
    <div className=" lg:flex md:flex grow-0 gap-3">
      <div className="flex">
        <div ref={dRef} className="disnone lg:flex-1 md:flex-1 sm:flex-none">
          ...
          {dropDown && (
            <ul
              ...
              style={{}}
            >
              <li className="justify-between font-serif font-medium py-2 pl-4 transition-colors duration-150 hover:bg-gray-100 text-gray-500 hover:text-customGreen dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200">
                <button
                  type="button"
              ...
              <li className="justify-center gap-3 font-serif font-medium py-2 pl-4 transition-colors duration-150 hover:bg-gray-100 text-gray-500 hover:text-customGreen dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200">
                <button
                  type="button"
                  className="focus:outline-none"
            ...
            <div className="h-10 border border-dashed border-customGreen rounded-md">
              <label className="w-full rounded-lg h-10 flex justify-center items-center text-xs dark:text-gray-400 leading-none px-2">
                ...
                {filename ? (
                  ...
                  <>
                    <FiUploadCloud className="mx-2 text-customGreen text-lg dark:text-gray-400" />{" "}
