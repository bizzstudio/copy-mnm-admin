        ...
        <div className="col-span-12 md:col-span-12 lg:col-span-12">
          ...
          <div className="grow scrollbar-hide w-full max-h-full xl:px-10">
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
              ...
              <div className="sm:col-span-4">
                <Uploader imageUrl={headerLogo} setImageUrl={setHeaderLogo} folder='HomePage' />
              </div>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo
                    ...
                    type="text"
                    placeholder="https://MNM יבוא שיווק והפצה-store.vercel.app/search?category=fruits-vegetable&_id=632aca2b4d87ff2494210be8"
                  />
          ...
          <div className="xl:px-10 grow scrollbar-hide w-full max-h-full pb-0">
            ...
            >
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <Uploader imageUrl={footerLogo} setImageUrl={setFooterLogo} folder='HomePage' />
                </div>
              </div>
