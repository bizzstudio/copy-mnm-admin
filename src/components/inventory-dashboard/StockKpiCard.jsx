// src/components/inventory-dashboard/StockKpiCard.jsx
import Skeleton from "react-loading-skeleton";

/**
 * כרטיס מדד עליון בדשבורד המלאי.
 * זהה בעיצוב ל-KpiCard של דשבורד המכירות, אבל במקום שינוי מול תקופה קודמת
 * מוצגת שורת הקשר — מלאי הוא תצלום רגע ואין לו תקופה להשוות אליה.
 */
const StockKpiCard = ({ title, value, subtitle, Icon, tone = "blue", loading }) => {
  const tones = {
